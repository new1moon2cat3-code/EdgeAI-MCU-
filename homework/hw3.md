作業內容
3.功能: YOLOv7 神經網路模型 偵測person, bicycle, car, motorcycle, bus, truck
         + WebSocker Viewer 
         + NTPClient (年月時日分秒 檔案名)
範例: 
Sketch > AMB82-mini > YOLOv7_Survellience 
需要修改紀錄時間的限制 
        if(hour>=0 && hour<=6) {
改成
        if(hour>=0) {
...
成果
![成果1](../images/ObjDet_2026_3_26_16_36_39.jpg)
![成果2](../images/ObjDet_2026_3_26_16_36_52.jpg)
